...
if os.getenv('GAE_INSTANCE'):
    ...
    ALLOWED_HOSTS = ['wishlist-274905.appspot.com']
else:
...
DATABASES = {
    'default': {
        ...
        'HOST': '/cloudsql/wishlist-274905:us-central1:wishlisted-db',
        'PORT': '5432'
    }
}
...
if os.getenv('GAE_INSTANCE'):
    ...
    GS_STATIC_FILE_BUCKET = 'wishlist-274905.appspot.com'

    STATIC_URL = f'https://storage.cloud.google.com/{GS_STATIC_FILE_BUCKET}/static/'

    DEFAULT_FILE_STORAGE = 'storages.backends.gcloud.GoocleCloudStorage'
    GS_BUCKET_NAME = 'user-images-1234'
